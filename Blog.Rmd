...
```{marginfigure}
*Sulla sinistra la word clowd creata da Twitter mentre a destra quella creata sui dati Instragram.*
```
```{r error=FALSE, message=F,warning=F,echo = F, out.width="100%"}
library(knitr)
knitr::include_graphics("C:\\Users\\Utente\\Desktop\\Univerisità\\Statistical learning\\Ecosia\\Financial report\\immagini\\social_network.png")
```
